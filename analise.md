...
Sobre a revisão constitucional de 1997: permite «sistemas mistos, com círculos plurinominais e uninominais (**podendo haver mesmo só um círculo plurinominal interno, o nacional**), desde que respeitada a prevalência da proporcionalidade e do método d'Hondt».
...
### [Zug (2010 - BGE 136 I 376)](http://relevancy.bger.ch/cgi-bin/JumpCGI?id=BGE-136-I-376)
...
Estes cantões acabaram por manter os círculos existentes, mas o cálculo total de deputados para cada partido passou a ser feito com base na sua votação total, sendo depois os mandatos alocados aos círculos através do [método de dupla proporcionalidade](https://www.math.uni-augsburg.de/htdocs/emeriti/pukelsheim/2008e-en.pdf).

Decisões posteriores ([Argóvia](http://relevancy.bger.ch/cgi-bin/JumpCGI?id=BGE-131-I-74), [Valais](http://relevancy.bger.ch/cgi-bin/JumpCGI?id=BGE-140-I-107), [Uri](http://relevancy.bger.ch/cgi-bin/JumpCGI?id=BGE-143-I-92)) reforçaram que o isolamento geográfico, a tradição histórica, linguística, ou a coesão regional não bastam para justificar desvios significativos à igualdade do voto.

Uma análise mais detalhada, incluindo transcrições dos acórdãos e uma comparação com o sistema eleitoral português, encontra-se em [documento anexo](suica.html).
...
«O princípio da representação proporcional deve ser definido como um conjunto de elementos pelos quais o resultado eleitoral é determinado e garantido, não apenas no distrito eleitoral (o que pode tornar-se uma caricatura da representação proporcional na prática), mas através da conversão dos votos recebidos pelos partidos políticos em mandatos para preencher os lugares disponíveis no órgão eleito (Câmara dos Deputados).»
